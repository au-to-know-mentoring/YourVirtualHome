...
public class DownloadHandler : MonoBehaviour
{
    ...
    void DownloadFile()
    {
        ...
        Uri uri = new Uri("http://13.239.5.145/virtualhome-remote/getModel/" + myInput); //https://github.com/ATK-mentoring/fbx-examples/blob/main/ArchicadObjSize.zip localhost:3000/virtualhome-remote/getModel/380150 // needs to be fixed to use our code input needs to be online tho
